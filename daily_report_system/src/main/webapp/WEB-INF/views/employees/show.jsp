...
<c:set var="commFoll" value="${ForwardConst.CMD_FOLLOW.getValue()}" />
...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <p>
            ...
            <p>
                <a  href="<c:url value='?action=${actEmp}&command=${commFoll}&id=${employee.id}' />">フォロー/解除</a>
            </p>

        <p>
            <a href="<c:url value='?action=${actEmp}&command=${commIdx}&id=${employee.id}' />">一覧に戻る</a>
        </p>
    </c:param>
</c:import>
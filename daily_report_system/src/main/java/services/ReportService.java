...
public class ReportService extends ServiceBase {
    ...
    public List<ReportView> getfolPerPage(FollowView follower,FollowView followee, int page){

        List<Report> reports = em.createNamedQuery(JpaConst.Q_REP_GET_ALL_MINE,Report.class)
                .setParameter(JpaConst.JPQL_PARM_EMPLOYEE,FollowConverter.toModel(followee))
                .setFirstResult(JpaConst.ROW_PER_PAGE * (page - 1))
                .setMaxResults(JpaConst.ROW_PER_PAGE)
                .getResultList();
        return ReportConverter.toViewList(reports);
    ...
    public long countAllfollow(EmployeeView followee) {

        long fol = (long) em.createNamedQuery(JpaConst.Q_FOL_COUNT_ALL_MINE, long.class)

...
public class EmployeeAction extends ActionBase {
    ...
    public void follow() throws ServletException, IOException {
        ...
        if (checkAdmin()) { //追記
            ...
            //詳細画面を表示
            forward(ForwardConst.FW_FOL_FOLVER);
        }

    }

    public void follower() throws ServletException, IOException {
      //セッションからログイン中の従業員情報を取得
        EmployeeView ev = (EmployeeView) getSessionScope(AttributeConst.LOGIN_EMP);
        EmployeeView followee = service.findOne(toNumber(getRequestParam(AttributeConst.EMP_ID)));
        ...
        List<FollowView> errors = service.follower(fv);
